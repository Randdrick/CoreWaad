...
public class SocketMgr
{
    ...
    private static List<Socket> fds = [];
    private static List<Socket> listenfds = [];
    ...
    public static void AddListenSocket(Socket s)
    {
...
public class Buffer
{
    ...
    internal static void BlockCopy(uint[] tbl, int v1, byte[] buffer, int v2, int size)
    {
        System.Buffer.BlockCopy(tbl, v1, buffer, v2, size);
    }
}
