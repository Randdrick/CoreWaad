...
{
    public const string ALERT_MESSAGE = "Votre message a été bloqué.";
    public const string ALERT_MESSAGE_1 = "Votre message contient des éléments interdits.";
    public const string PLAYER_NOT_FOUND = "Joueur {0} introuvable";
    public const string MUTED_MESSAGE = "Vous êtes muet à cause d'un modérateur.";
    public const string MUTED_TIME_LEFT = "Vous pourrez de nouveau parler dans {0} secondes.";
    public const string REPLY_MESSAGE = "Ce MJ n'a aucun ticket ouvert de votre part et n'a pas reçu votre requête. S'il vous plaît, soumettez une nouvelle demande de ticket si vous deviez parler à un MJ. Ceci est un message automatique.";
    public const string R_E_CHARHAN_COM = "Taille de paquet invalide : {0} octets (attendu {1} octets). Déconnexion.";
    public const string R_E_CHARHAN_COM_1 = "Erreur lors de la lecture du paquet : {0}";
    public const string R_D_CHATHAN = "Type de message non géré : {0}, Langue : {1}, Message : {2}";
    public const string R_D_CHATHAN_1 = "Langue invalide : {0}";
}
...
public static class CharacterHandler
{
    ...
    public const string R_E_CHARHAN_PL_6 = "Le GUID du personnage dans la base de données {0} ne correspond pas au GUID envoyé {1}. Tentative de connexion suspecte.";
    public const string R_E_CHARHAN_PL_7 = "L'instance pour la carte {0} n'existe plus ou n'a pas de serveur valide. Tentative de récupération...";
    public const string R_E_CHARHAN_PL_8 = "Impossible de trouver un serveur valide pour la carte de récupération {0}.";
    public const string R_E_CHARHAN_PL_9 = "Impossible de trouver une instance valide pour la carte de récupération {0}.";
    public const string R_E_CHARHAN_PL_10 = "Aucune information de carte de récupération trouvée pour la carte {0}.";
    public const string R_E_CHARHAN_PL_11 = "Impossible de créer le joueur pour le GUID {0}.";
    public const string R_W_CHARHAN_PL = "Le personnage {0} est banni.";
    public const string R_D_CHARHAN_PL = "Le personnage {0} (GUID: {1}) s'est connecté avec succès sur la carte {2}.";
    ...
    public const string R_N_CHARHAN_BR = "Limite DK atteinte pour le compte {0} !";
    public const string R_N_CHARHAN_BR_1 = "Le niveau 55 est requis pour créer un DK sur le compte{0}";
    public const string R_E_CHARHAN_CC = "Il n'y a pas de serveur de 'Monde' en ligne pour la création du personnage";
    public const string R_E_CHARHAN_CC_1 = "Id de compte {0} de session invalide";
    public const string R_D_CHARHAN_CD = "OpCode reçu : {0}";
    public const string R_D_CHARHAN_CD_1 = "GUID du personnage : {0}";
    public const string R_D_CHARHAN_CD_2 = "AccountId du personnage : {0}";
    public const string R_D_CHARHAN_CD_3 = "AccountId de la session : {0}";
    public const string R_D_CHARHAN_CD_4 = "Références du personnage : {0}";
    public const string R_W_CHARHAN_CD = "Le personnage avec le GUID {0} n'existe pas ou n'appartient pas au compte {1}";
    public const string R_W_CHARHAN_CD_1 = "Impossible de supprimer {0} : le personnage est le chef de la Guilde.";
    public const string R_W_CHARHAN_CD_2 = "Impossible de supprimer {0} : le personnage est le meneur de l'équipe.";
    public const string R_W_CHARHAN_CD_3 = "Aucune instance disponible pour la suppression du personnage.";
    public const string R_W_CHARHAN_CD_4 = "Erreur lors de la suppression des données du personnage {0} : ";
    public const string R_W_CHARHAN_CD_5 = "Le personnage n'existe pas dans le serveur de 'Monde'";
    public const string R_E_CHARHAN_CR = "Erreur lors du renommage du personnage {0} : {1}";
    public const string R_W_CHARHAN_CR = "Personnage {0} non trouvé ou n'appartient pas au compte {1}.";
    public const string R_W_CHARHAN_CR_1 = "Le Nom {0} invalide (erreur : {1}).";
    public const string R_W_CHARHAN_CR_2 = "Le nom {0} est interdit !";
    public const string R_W_CHARHAN_CR_3 = "Le nom {0} est déjà utilisé.";
    public const string R_W_CHARHAN_CR_4 = "Nom vide ou null. Déconnexion.";
    public const string R_D_CHARHAN_CR = "OpCode reçu : {0}";
    public const string R_D_CHARHAN_CR_1 = "GUID du personnage : {0}";
    public const string R_D_CHARHAN_CR_2 = "Nouveau nom proposé : {0}";
    public const string R_N_CHARHAN_CR = "Personnage {0} renommé en {1} avec succès.";
    ...
    public const string R_E_CHARHAN_UA = "Erreur lors de la décompression des données : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_1 = "Erreur lors de la lecture de l'ID du paquet : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_2 = "ID de slot invalide : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_3 = "Erreur lors de la lecture du timestamp : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_4 = "Erreur lors de la lecture de la taille des données : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_5 = "Effacement des données du slot {0} pour le compte {1}.";
    public const string R_E_CHARHAN_UA_6 = "Taille des données trop grande : {0} octets. Déconnexion.";
    public const string R_E_CHARHAN_UA_7 = "Taille des données trop grande pour le champ BLOB : {0} octets. Déconnexion.";
    public const string R_E_CHARHAN_UA_8 = "Aucune donnée compressée trouvée dans le paquet. Déconnexion.";
    public const string R_E_CHARHAN_UA_9 = "Erreur lors de la lecture des données compressées : {0}. Déconnexion.";
    public const string R_E_CHARHAN_UA_10 = "Données décompressées invalides ou potentiellement malveillantes. Déconnexion.";
    public const string R_E_CHARHAN_UA_11 = "Erreur lors de la sauvegarde des données : {0}.";
    public const string R_D_CHARHAN_UA = "Mise à jour des données du slot {0} pour le compte {1} (taille : {2} octets).";
    public const string R_E_CHARHAN_RA = "Erreur lors de la lecture de l'ID du slot : {0}. Déconnexion.";
    public const string R_E_CHARHAN_RA_1 = "ID de slot invalide  : {0}. Déconnexion.";
...
public static class WorldSocket
{
    ...
    public const string R_E_WRDSOCK_1 = "Erreur dans AUTH_SESSION : {0}";
    public const string R_E_WRDSOCK_2 = "Echec dans la création de la session !";
    public const string R_E_WRDSOCK_3 = "m_session est null. Le chargement ne peut pas continuer";
    public const string R_E_WRDSOCK_4 = "Erreur de chargement de l'addon : {0}";
    public const string R_E_WRDSOCK_5 = "UpdateQueuedPackets : erreur de socket lors du nettoyage de la file d'attente, suppression de la file d'attente";
    ...
    public const string R_D_WRDSOCK_3 = "Taille de paquet invalide";
    public const string R_D_WRDSOCK_3_1 = "Échec de la décompression ou incompatibilité de taille des données d'addon.";
    public const string R_D_WRDSOCK_4 = "Section d'Addon Ok";
    public const string R_D_WRDSOCK_5 = "UpdateQueuedPackets : la mémoire tampon est toujours pleine, le traitement de la file d'attente est suspendu";    
...
public static class ConsoleCommands
{
    ...
    public const string R_N_CONCMD_I_3 = "Joueurs en ligne: {0} ({1} GMs, {2} en attente)\r\n";
...
public static class ClusterManager
{
    ...
    public const string R_W_CLUSMGR = "Suppression de l'instance {0} sur la Map {1} suite à la déconnexion du serveur de 'Monde'";
    public const string R_W_CLUSMGR_1 = "Suppression de l'instance {0} suite à la déconnexion du serveur de 'Monde'";
    public const string R_W_CLUSMGR_2 = "Suppression de la Map {0} suite à la déconnexion du serveur de 'Monde'";
    public const string R_W_CLUSMGR_3 = "Suppression du serveur de 'Monde' {0} suite à la fermeture du socket";
}
...
public static class WorkerServer
{
    ...
    public const string R_D_WORKMGR_1_1 = "Ne trouve pas d'instance. Le transfert est annulé...";
    ...
    public const string R_W_WORKMGR = "Session ID : {0} non trouvée pour la connexion du joueur";
    ...
    public const string R_E_WORKMGR_4 = "Pas de serveur valide pour le joueur : GUID '{0}'";
    public const string R_E_WORKMGR_5 = "Pas d'instance' valide pour le joueur : GUID '{0}'";
...
public static class Master
{
    ...
    public const string R_E_MASTER_9 = "Echec du chargement du fichier de configuration. Veuillez vérifier votre fichier.";
    public const string R_E_MASTER_10 = "Impossible de réinitialiser l'instance de ClientMgr : backing field introuvable.";
    ...
    public const string R_N_MASTER_6 = "Début de la séquence d'arrêt du serveur à {0}.";
    public const string R_N_MASTER_7 = "Fermeture du LogonCommHandler";
    public const string R_N_MASTER_8 = "Fermeture de l'écouteur du serveur de monde (world listener)...";
    public const string R_N_MASTER_8_1 = "Ecouteur du serveur de monde (world listener) fermé...";
    public const string R_N_MASTER_9 = "Fermeture de l'écouteur serveur de travail (worker server listener)...";
    public const string R_N_MASTER_9_1 = "Ecouteur serveur de travail (worker server listener) fermé...";
    public const string R_N_MASTER_10 = "LogonCommHandler libéré et instance réinitialisée.";
    public const string R_N_MASTER_11 = "Fermeture de tous les sockets via SocketMgr...";
    public const string R_N_MASTER_11_1 = "Tous les sockets sont fermés...";
    public const string R_N_MASTER_12 = "Fichiers DBC déchargés...";
    public const string R_N_MASTER_13 = "Suppression des connexions à la base de données...";
    public const string R_N_MASTER_14 = "Connexions à la base de données supprimées.";
    public const string R_N_MASTER_15 = "Arrêt du NetworkThreadPool...";
    public const string R_N_MASTER_15_1 = "NetworkThreadPool arrêté avec succès.";
    public const string R_N_MASTER_16 = "Destruction du BufferPool...";
    public const string R_N_MASTER_16_1 = "BufferPool détruit avec succès.";
    public const string R_N_MASTER_17 = "Nettoyage des DBC/Storage...";
    public const string R_N_MASTER_17_1 = "DBC/Storage nettoyé avec succès.";
    public const string R_N_MASTER_18 = "Libération des ressources....";
    public const string R_N_MASTER_18_1 = "Ressources libérées avec succès.";
    public const string R_N_MASTER_19 = "Nettoyage des instances singleton (ClusterMgr, ClientMgr, ChannelMgr)...";
    public const string R_N_MASTER_20 = "Nettoyage des instances singleton terminé.";
    public const string R_N_MASTER_21 = "Séquence d'arrêt du serveur terminée avec succès.";
