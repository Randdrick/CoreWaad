...
public enum WorkerServerOpcodes : ushort
{
    ...
    ISMSG_DELETE_PLAYER = 42,
    ICMSG_REALM_PING_STATUS = 43,
    IMSG_NUM_TYPES
}

public enum MsgChannelAction : byte
{
    CHANNEL_JOIN,
    CHANNEL_PART,
    CHANNEL_SAY
...
public enum CmsgChannelUpdate : byte
{
